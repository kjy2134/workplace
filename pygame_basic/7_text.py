...
#20fps : 1초동안 20번 동작해야 -> 1번에 5만큼 20*5 =100
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYUP: # 키가 눌려지지 않았을 때
...
#충돌처리 위한 rect정보 업뎃
    ...
    character_rect.left = character_x_pos #화면상 왼쪽
    character_rect.top = character_y_pos # 화면상 맨 위
...
#잠시 대기
pygame.time.delay(2000)#괄호안 단위 ms, 2초정도 대기
#pygame종료
pygame.quit()